...
layout: page
title: Resources
subtitle: Frameworks and reference material for grounding AI transformation in governance, accountability, and people.
permalink: /resources/
---

Practical artifacts for enterprise AI leaders, distilled, opinionated, and free to use under [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/).

## Published

<div class="card-grid">
  <a class="card reveal" data-stagger="0" href="{{ '/resources/2026-05-graph-based-ml-ai-taxonomy.html' | relative_url }}">
    <span class="card-thumb"><img src="{{ '/assets/img/thumbnails/resource-graph-ml.png' | relative_url }}" alt="Evolutionary lineage abstract" loading="lazy"></span>
    <p class="card-meta">Field Taxonomy · Reference</p>
  ...
  <a class="card reveal" data-stagger="1" href="{{ '/resources/2026-05-snn-neuromorphic-taxonomy.html' | relative_url }}">
    <span class="card-thumb"><img src="{{ '/assets/img/thumbnails/resource-neuromorphic.png' | relative_url }}" alt="Neuromorphic computing abstract" loading="lazy"></span>
    <p class="card-meta">Field Taxonomy · Reference</p>
  ...
  <a class="card reveal" data-stagger="2" href="{{ '/resources/icm-workspace-explorer/' | relative_url }}">
...
The first wave of frameworks is being prepared for publication. Topics under development:

- AI Center of Excellence operating models
- Governance scaffolding for early enterprise AI programs
- Coalition-building patterns for cross-functional alignment
